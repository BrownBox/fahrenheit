...
if (false === ($ob = get_transient($transient))) {
    ...
    // section content
?>
    <div class="children-as-tabs row collapse" data-equalizer="tabs" data-equalize-on="medium">
        <aside class="medium-8 large-5 column" data-equalizer-watch="tabs">
            <?php get_sidebar('children-as-tabs'); ?>
        </aside>
        <div class="small-24 medium-16 large-19 float-left column">
