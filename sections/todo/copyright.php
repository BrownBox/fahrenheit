...
if (false === ($ob = get_transient($transient))) {
    ...
    // section content
?>
 <div class="small-24 medium-16 column hide-for-print" data-swiftype-index="false">
    <?php echo bb_get_theme_mod('bb_copyright'); ?> | Sitecraft by <a href="http://brownbox.net.au/">Brown Box</a>
</div>
<div class="small-24 medium-8 column hide-for-print no-bullet" data-swiftype-index="false">
	<ul>
    	<?php bb_menu('last'); ?>
    </ul>
</div>
